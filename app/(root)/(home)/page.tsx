...
const Home = () => {
  ...
  return (
    <section className="flex size-full flex-col gap-7 text-white">
      <div className="relative h-[240px] max-md:h-[200px] w-full rounded-[20px] bg-cover bg-no-repeat overflow-hidden">
        {/* Background wrapper */}
        <div
          style={{
            position: "absolute",
        ...
        <div className="relative z-10 flex h-full flex-col justify-between max-md:px-2 max-md:py-4 lg:p-3">
          ...
          <div className="flex flex-col gap-2 pr-4 pb-2 ">
            <h1 className="text-4xl font-extrabold lg:text-6xl text-shadow-lg">
              {time}
            </h1>
